...
const AVAILABLE_ICONS = [
  'ArrowDownCircle', 'ArrowUpCircle', 'Banknote', 'BarChart3', 'Building2',
  'Calculator', 'CheckCircle', 'CreditCard', 'DollarSign', 'Download',
  'FileBarChart', 'FileCheck', 'FileText', 'Folder', 'Home', 'Key',
  'Lightbulb', 'LogOut', 'Package', 'PieChart', 'Receipt', 'RefreshCw',
  'ScanText', 'Send', 'Settings', 'Shield', 'Sparkles', 'TrendingUp',
  'Upload', 'User', 'Users', 'Webhook'
];
